export default function Tips() {
    ...
    return (
            <div className="tipsCard">
                <div className="tips tips1">
                    <img src="./images/bowl-food-light.svg" alt="" />
                ...
                <div className="tips tips2">
                    <img src="./images/barbell-light.svg" alt="" />
                ...
                <div className="tips tips3">
                    <img src="./images/moon-stars-light.svg" alt="" />
